# Instalação do Portal do Cliente — Logás (Windows)
#
# Abra o PowerShell NA PASTA onde estão estes arquivos e rode:
#
...
Write-Host "  1) Cadastre os clientes:  .\cadastrar.ps1"
Write-Host "  2) Suba o portal:         .\iniciar.ps1"
Write-Host "  3) Para publicar para fora e virar servico, veja o README."
Write-Host ""
