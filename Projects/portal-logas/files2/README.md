...
- **Panorama dos pontos**: todos os pontos legíveis do `dados.js` numa tabela só,
  ordenados por urgência — pressão, consumo, média por dia com a variação
  semanal, autonomia, quando chega na reserva, última troca de carreta e a
  situação. Inclui os pontos que ainda não têm cliente vinculado.
